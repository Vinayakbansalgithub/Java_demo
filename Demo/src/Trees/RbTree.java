...
class RBTreeNode {
	...
	public RBTreeNode(String data) {
		// Color R- Red
		// and B - Black
		this.data = data;
		this.color = "R";
		children = new RBTreeNode[2];
		children[0] = null;
		children[1] = null;
	}
}
...
public class RbTree {
	...
	RBTreeNode SingleRotate(RBTreeNode Node, int dir) {
		RBTreeNode temp = Node.children[check(dir)];
	...
	RBTreeNode Insert(RbTree tree, String data) {
		if (tree.Root == null) {
