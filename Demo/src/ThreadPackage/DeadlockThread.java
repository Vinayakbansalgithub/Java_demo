	...
	public static void main(String[] args) {
		...
		if (ids != null) {
			...
			for (ThreadInfo threadInfo1 : threadInfo) {
				...
				System.out.println("Lock name: "+threadInfo1.getLockName()); // Prints the string representation of an object for
																// which thread has entered into deadlock.

				System.out.println("Prints the ID of thread which currently owns the lock "+threadInfo1.getLockOwnerId()); // Prints the ID of thread which currently owns the
																	// object lock

				System.out.println("Prints the name of thread which currently owns the lock "+threadInfo1.getLockOwnerName()); // Prints name of the thread which currently owns
																	// the object lock.
